...
$rtwwwap_html1 .=   '          <div class="rtwwwap-tools-section rtwwwap_hide" id="rtwwwap_generate_link">
                                    <div class="rtwwwap_generate_link_row">
                                        ...
                                        <div class="rtwwwap_generate_link_text_wrapper">
                                            ...
                                            <button class="mdc-button mdc-button--raised" id="rtwwwap_generate_button" data-rtwwwap_aff_id="'.esc_attr( get_current_user_id() ).'"  data-rtwwwap_aff_slug="'.$rtwwwap_affiliate_slug.'" data-rtwwwap_aff_name="'.esc_attr($rtwwwap_user_name_new).'">
