		...
		if( $rtwwwap_comm_base == 1 ){
			foreach( $rtwwwap_commissions as $rtwwwap_key => $rtwwwap_value ){
				...
				elseif( $rtwwwap_key == 'per_prod_mode' ){
					...
					$rtwwwap_html1 .= 		 		esc_html__( 'Per Product Commission' );
					$rtwwwap_html1 .= 			'</th>';
					$rtwwwap_html1 .= 		'</tr>';
					$rtwwwap_html1 .= 	'</thead>';
				...
				elseif( $rtwwwap_key == 'per_cat' ){
					...
					$rtwwwap_html1 .= 		'<tr>';
					$rtwwwap_html1 .= 			'<th colspan="3">';
					$rtwwwap_html1 .= 		 		esc_html__( 'Per Category Commission' );
					$rtwwwap_html1 .= 			'</th>';
					$rtwwwap_html1 .= 		'</tr>';
					$rtwwwap_html1 .= 	'</thead>';
...
if( isset( $_GET[ 'rtwwwap_tab' ] ) && $_GET[ 'rtwwwap_tab' ] == 'affiliate_tools' ){
	...
	$rtwwwap_html1 .=	    	'<input type="button" id="rtwwwap_generate_button" data-rtwwwap_aff_id="'.esc_attr( get_current_user_id() ).'" data-rtwwwap_aff_slug="'.$rtwwwap_affiliate_slug.'" data-rtwwwap_aff_name="'.esc_attr( $rtwwwap_user_name_new ).'" value="'.esc_attr__( 'Generate link', 'rtwwwap-wp-wc-affiliate-program' ).'" />';
