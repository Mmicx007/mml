...
if( isset( $_GET[ 'rtwwwap_tab' ] ) && $_GET[ 'rtwwwap_tab' ] == 'affiliate_tools' ){
	...
	$rtwwwap_html1 .=	    	'<input type="button" id="rtwwwap_generate_button" data-rtwwwap_aff_id="'.esc_attr( get_current_user_id() ).'" data-rtwwwap_aff_slug="'.$rtwwwap_affiliate_slug.'" data-rtwwwap_aff_name="'.esc_attr( $rtwwwap_user_name ).'" value="'.esc_attr__( 'Generate link', 'rtwwwap-wp-wc-affiliate-program' ).'" />';
...
if( isset( $_GET[ 'rtwwwap_tab' ] ) && $_GET[ 'rtwwwap_tab' ] == 'profile' ){
    ...
    $rtwwwap_html1 .= 	'<div>';
	$rtwwwap_html1 .= 		'<div><input type="submit" class="rtwwwap_profile_save_btn" value="'.esc_html__( "Update Details", "rtwwwap-wp-wc-affiliate-program" ).'" id="rtwwwap_profile_save" name="rtwwwap_profile_save"></div>';
